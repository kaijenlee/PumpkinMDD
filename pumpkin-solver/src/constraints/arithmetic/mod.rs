...
pub fn times(
    ...
    SingleInferencePropagatorArgs {
        wrapped_args: IntegerMultiplicationPropagator::new(a, b, c),
        constraint_tag,
    }
}
...
pub fn division(
    ...
    SingleInferencePropagatorArgs {
        wrapped_args: DivisionPropagator::new(numerator, denominator, rhs),
        constraint_tag,
    }
}
...
pub fn absolute(
    ...
    SingleInferencePropagatorArgs {
        wrapped_args: AbsoluteValuePropagator::new(signed, absolute),
        constraint_tag,
    }
}
...
pub fn maximum<Var: IntegerVariable + 'static>(
    ...
    SingleInferencePropagatorArgs {
        wrapped_args: MaximumPropagator::new(array.into_iter().collect(), rhs),
        constraint_tag,
    }
}
